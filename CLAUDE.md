...
**Known trade-offs of the `qwen36` profile, unchanged from prior testing:** context is halved (4096 vs. production's 32768), and only `is_prime`/`reverse_string` have been retested with the tuned config — broader prompt coverage and a soak test are still open items (see previous section).
